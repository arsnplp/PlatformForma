...
export const DEFAULT_PROCESS: DefaultStep[] = [
  ...
  // Phase 3
  { phase: 3, name: "Convocation envoyée", assignee: "assistant", trigger: "time_offset", anchor: "start_date", offset: -7 },
  { phase: 3, name: "Livret + Charte + RI envoyés", assignee: "assistant", trigger: "time_offset", anchor: "start_date", offset: -7 },
  { phase: 3, name: "Identifiants + lien Meet envoyés", assignee: "proprio", trigger: "time_offset", anchor: "start_date", offset: -2 },
  ...
  // Phase 5
  { phase: 5, name: "Attestation + Éval finale + Bilan APPRENANT envoyés", assignee: "proprio", trigger: "time_offset", anchor: "end_date", offset: 0 },
  ...
  // Phase 6
  { phase: 6, name: "Relance bilans 48h", assignee: "proprio+assistant", trigger: "time_offset", anchor: "end_date", offset: 2 },
  ...
  { phase: 7, name: "Enquête à froid envoyée", assignee: "proprio", trigger: "time_offset", anchor: "end_date", offset: 90 },
];

// Traduit une étape par défaut en données StepTemplate (sans ids), pour un propriétaire donné.
export function toStepTemplateData(step: DefaultStep, order: number, ownerId: string) {
